...
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "Title" /t REG_SZ /d "EZE OS" /f >NUL 2>nul
@REM reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "URL" /t REG_SZ /d "https://github.com/BaskaranElilan/EZE-OS" /f >NUL 2>nul
